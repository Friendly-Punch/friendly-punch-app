...
# 支出カテゴリ（年間増減率）
# ----------------------------------------
def expense_with_growth(base, growth, years):
    ...
    for month in range(12):
        ...
        if age == house_age and month == 6:
            if value_cash >= house_cost:
                ...
                value_cash = max(0, value_cash - down_payment)
                loan_amount = house_cost - down_payment
                loan_payments.append(loan_amount / (30 * 12))
        ...
        if age == car_age and month == 6:
            if value_cash >= car_cost:
                ...
                loan_payments.append(loan_amount / (5 * 12))

        # 教育費
        if age == edu_age and month == 4:
            if value_cash >= edu_cost:
                ...
                loan_payments.append(loan_amount / (10 * 12))

        # 結婚
        if age == marriage_age and month == 9:
